...
> "Nay, J., Gilligan, J. 2015. Data-Driven Dynamic Decision Models. 
...
```{r, eval=TRUE, include=TRUE, render.args = list(help = list(sections = list("usage", "arguments", "details", "references")))}
?evolve_model
````
